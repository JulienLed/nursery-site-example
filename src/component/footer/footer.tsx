...
export default function Footer() {
  return (
    <Card className="min-w-screen bg-green-900 !border-0 !rounded-none z-99">
      <CardContent className="grid gap-2 grid-cols-[20vw_40vw_35vw] items-center text-[0.8rem] text-popover font-semibold">
        <section id="logo">
          <Image
            alt="Logo crêche"
            src={logo}
