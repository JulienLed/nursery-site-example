...
export default function Page() {
  return (
    <Card className="max-w-full w-full animate-fade-left duration-200 leading-8 sm:leading-10 !bg-amber-300 !border-none !shadow-2xl">
      ...
      <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-10 animate-fade-left delay-500 bg-amber-500 !border-none rounded-2xl m-5 p-10">
        {menu[2].content?.map((projet) => {
          return (
            ...
            >
              <Card className="flex flex-col bg-amber-300 !border-none !shadow-2xl hover:!text-accent transition-all duration-200 ease-in-out">
                <CardHeader>
