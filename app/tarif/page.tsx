      ...
      <Card className="max-w-full w-full animate-fade-left duration-200 leading-8 sm:leading-10 !bg-accent !border-none !shadow-2xl">
        <CardHeader>
          ...
          <CardDescription className="text-chart-4 text-xl text-justify pb-5">
            Nous facturons 90€ par journée. Découvrez votre prix en complétant
          ...
          <Card className="animate-fade-left delay-500 bg-popover !border-none !shadow-2xl">
            <div className="flex flex-col items-center gap-5 w-[60vw] sm:w-[50vw]">
              ...
              <Input
                ...
                className="w-[10vw] border-amber-800 bg-amber-800 hover:bg-accent/80 text-chart-4 transition-all duration-200 ease-in"
              />
              <Button
                onClick={() => handleValidate()}
                className="hover:scale-110 hover:bg-accent/80 bg-accent active:translate-y-0.5 rounded-2xl transition-all duration-200 ease-in-out"
              >
                Valider
              </Button>
            </div>
